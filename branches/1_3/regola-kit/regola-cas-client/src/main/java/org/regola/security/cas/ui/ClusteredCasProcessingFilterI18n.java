...
/**
 * Processa un CAS service ticket con il supporto per il funzionamento in
 * cluster con sticky session. Vedere
 * {@link org.acegisecurity.ui.cas.CasProcessingFilter} Modificato per
 * aggiungere anche il parametro della lingua passato da CAS.
 * 
 * @author marco
 * 
 */
