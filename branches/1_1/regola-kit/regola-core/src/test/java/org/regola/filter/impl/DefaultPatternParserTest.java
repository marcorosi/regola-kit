 ...
 * @author marco
 */
public class DefaultPatternParserTest {

	ModelPatternParser fb = new DefaultPatternParser();
	...
	public void testInFilter() {
		modelFilter.setHobbies(Arrays.asList(new String[] { "cooking",
				"jogging" }));
		fb.createQuery(criteria, modelFilter);

		assertEquals("hobbies IN '[cooking, jogging]'", criteria
				.printCriterion());
	}
}
