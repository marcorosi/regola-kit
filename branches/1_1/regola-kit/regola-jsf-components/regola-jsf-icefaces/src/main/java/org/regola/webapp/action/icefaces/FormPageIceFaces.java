...
public class FormPageIceFaces<T, ID extends Serializable, F extends ModelPattern>
        extends BasePageIceFaces implements FormPageComponent<T, ID, F> {
    ...
    public <T> InvalidValue[] validate(InvalidValue[] msgs) {
        ...
        //InvalidValue[] msgs = formPage.validate(object);
