...
Come si vede la proprietà sintesi contiene la logica per fornire una semplice rappresentazione del sottoinsieme $\alpha$ anche nel caso in cui inizioDescrizione sia nullo.
