...
/**
 * Adapetd from org.trails.descriptor.TrailsClassDescriptor
 */
...
public class TrailsClassDescriptor extends TrailsDescriptor implements IClassDescriptor
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 101458511892018392L;
	@SuppressWarnings("unchecked")
    ...
    {
        String ognl = "propertyDescriptors.{? name=='id'}[0]";
    ...
    public String getPluralDisplayName()
    {
    	...
    	return unCamelCase(getDisplayName());
    }
